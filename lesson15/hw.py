...
print("================================")
print("\n1. with open() as f: Used for safe file handling.")
print("2. split(): Used to count words in each line.")
print("3. os.path.exists(): Used to check if a file exists.")
print("4. os.remove(): Used to delete an old file.")
print("5. File Merge: Science and Maths notes combined into one file.")
print("\n================================")
